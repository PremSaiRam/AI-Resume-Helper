...
export default function Login({ onLogin }) {
  ...
  const handleGoogleLogin = () => {
    // Open a small popup to login with Google
  ...
  // Check if display name already exists in localStorage
  const storedName = localStorage.getItem("displayName");
  if (storedName && !askName) {
    onLogin({ displayName: storedName });
    return null; // Don't render login if already have name
  }
